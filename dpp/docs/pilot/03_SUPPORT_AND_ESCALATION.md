...
**에스컬레이션:** 즉시 이메일 발송, 30분 무응답 시 이메일 재발송
...
**에스컬레이션:** 이메일 발송, 2시간 무응답 시 이메일 재발송
...
- SLA-lite(파일럿): `16_SLA_LITE.md`
- 분쟁 대응(과금/장애/보안): `12_DISPUTE_PLAYBOOK.md`
